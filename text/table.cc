// $Id: table.cc 4340 2011-10-15 05:13:27Z haowu $
...
void Table::ParseRow(const string& str, Row* p_row)
{
  string::const_iterator iter = str.begin();
  string value = "";
  while (iter != str.end() && *iter != '\r') {
    ParseValue(&iter, &value);
...
void Table::ParseValue(string::const_iterator* p_iter, string* p_value)
{
